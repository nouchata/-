...
export class FindUserDTO {
	...
	@ApiProperty({
		description:
			"Information about the user's ranking and victories/losses ratio",
	})
	@ValidateNested()
	ranking: RankingInfo;

	@ApiProperty({
		description: 'Array with all the history of matches of the user',
	})
	@ValidateNested()
	...
	@ApiProperty({
		description:
			'Needed to inform the frontend that the user logged in can edit these informations',
	})
	@IsBoolean()
	isEditable: boolean;
}
